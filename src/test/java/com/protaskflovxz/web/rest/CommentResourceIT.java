...
import static com.protaskflovxz.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.protaskflovxz.repository.CommentRepository;
import com.protaskflovxz.service.dto.CommentDTO;
import com.protaskflovxz.service.mapper.CommentMapper;
...
class CommentResourceIT {
    ...
    public static Comment createEntity() {
        return new Comment().content(DEFAULT_CONTENT).postedDate(DEFAULT_POSTED_DATE);
    }
    ...
    public static Comment createUpdatedEntity() {
        return new Comment().content(UPDATED_CONTENT).postedDate(UPDATED_POSTED_DATE);
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.content(UPDATED_CONTENT).postedDate(UPDATED_POSTED_DATE);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).postedDate(UPDATED_POSTED_DATE);
