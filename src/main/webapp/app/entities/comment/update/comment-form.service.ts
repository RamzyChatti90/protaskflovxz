 ...
 */
type FormValueOf<T extends IComment | NewComment> = Omit<T, 'postedDate'> & {
...
type CommentFormDefaults = Pick<NewComment, 'id' | 'postedDate'>;
...
type CommentFormGroupContent = {
  ...
  postedDate: FormControl<CommentFormRawValue['postedDate']>;
...
export class CommentFormService {
  createCommentFormGroup(comment: CommentFormGroupInput = { id: null }): CommentFormGroup {
    ...
    return new FormGroup<CommentFormGroupContent>({
      ...
      postedDate: new FormControl(commentRawValue.postedDate),
  ...
  private convertCommentRawValueToComment(rawComment: CommentFormRawValue | NewCommentFormRawValue): IComment | NewComment {
    return {
      ...rawComment,
      postedDate: dayjs(rawComment.postedDate, DATE_TIME_FORMAT),
    };
  }
  ...
  private convertCommentToCommentRawValue(
    ...
    return {
      ...comment,
      postedDate: comment.postedDate ? comment.postedDate.format(DATE_TIME_FORMAT) : undefined,
    };
  }
}
